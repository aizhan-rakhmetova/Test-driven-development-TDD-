...
test('test city should contain 3 houses', () =>{
    ...
    expect(city.houses[2].buildedAt).toBe(2029);
...
test('test city should contain hospital and fire station', () =>{
    ...
    expect(city.governmentBuildings[1].budget).toBe(2000);
    expect(city.governmentBuildings[1].staffCount).toBe(1000);
    expect(city.governmentBuildings[1].address.street.title).toBe("Central");
